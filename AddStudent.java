...
for(int i=0;i<Sid.length();i++)
{
	...
	else
	{
		...
		t=1;
		new Music().music2();
		JOptionPane.showMessageDialog(c,"Invalid Student Id");
		txtSid.setText("");
		txtSid.requestFocus();
		}
...
catch(Exception e)
{
	...
	new Music().music2();
	JOptionPane.showMessageDialog(c,"Enter valid Student data");
